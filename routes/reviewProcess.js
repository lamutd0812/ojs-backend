...
router.post('/request-author-revision/:submissionId',
    checkAuth,
    restrict([USER_ROLES.EDITOR.permissionLevel]),
    reviewProcessController.requestAuthorRevision);
...
router.put('/author-assignment/:submissionId',
    checkAuth,
    restrict([USER_ROLES.AUTHOR.permissionLevel, USER_ROLES.EDITOR.permissionLevel, USER_ROLES.REVIEWER.permissionLevel,]),
    uploadFile.fields([
